...
public class Board_2 implements ConstDef {
	...
	final Piece[][] initialBoard = {
		{ null, null, null, new Pawn(BLACK), new Pawn(BLACK), new Pawn(BLACK), new Pawn(BLACK), new Pawn(BLACK), new Pawn(BLACK), new Pawn(BLACK), new Pawn(BLACK), null, null, null, },
		{ null, null, null, new Rook(BLACK), new Knight(BLACK), new Bishop(BLACK), new Queen(BLACK), new King(BLACK), new Bishop(BLACK), new Knight(BLACK), new Rook(BLACK), null, null, null },
		...
		{ new Rook(RED), new Pawn(RED), null, null, null, null, null, null, null, null, null, null, new Pawn(GREEN), new Rook(GREEN)},
		{ null, null, null, null, null, null, null, null, null, null, null, null, null, null},
		{ null, null ,null, new Pawn(WHITE), new Pawn(WHITE), new Pawn(WHITE), new Pawn(WHITE), new Pawn(WHITE), new Pawn(WHITE), new Pawn(WHITE), new Pawn(WHITE), null, null, null},
		{ null, null, null, new Rook(WHITE), new Knight(WHITE), new Bishop(WHITE), new Queen(WHITE), new King(WHITE), new Bishop(WHITE), new Knight(WHITE), new Rook(WHITE), null, null, null}
		};
